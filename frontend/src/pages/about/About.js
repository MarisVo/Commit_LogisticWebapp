function About() {
    ...
    return (
        <div className='pt-[65px]'>
            ...
            <div className='xl:relative container mx-auto my-10'>
                <div className="xl:absolute xl:w-full xl:grid xl:grid-cols-[30%_60%] bottom-4 top-4 left-4  mx-auto ">
                    ...
                    <div className='absolute xl:static flex flex-row gap-x-3 justify-center h-full py-2'>
