    ...
    return (
        <>
            ...
            <div className="m-auto max-w-[1140px]  px-[16px] lg:px-[0px]  mt-[32px] lg:mt-[180px]">
                <h2 className="text-[24px] lg:text-[32px] font-bold mb-6">[HCM _ Q2] _ INTERNAL CONTROL SPECIALIST</h2>
                <div className="gap-4 lg:grid lg:grid-cols-2 bg-[#f2f2f2]">
                    ...
                    <div className="p-4">
                        ...
                        <p className="py-2 ml-5">
                            08:00 - 17:30, từ thứ 2 - thứ 6 | 08:00 - 12:00, thứ 7 <br /> Nghỉ trưa 12:00 - 13:30
                        </p>
                        <hr />
                    </div>
                    <div className="p-4">
                        ...
                        <p className="py-2 ml-5">9F, Sofic Tower, 10 Mai Chi Tho, Thu Thiem Ward, District 2, HCMC.</p>
                        <hr />
                    </div>
                </div>
                ...
                <article className="tracking-wide">
                    ...
                    <p>
                        <FontAwesomeIcon className="mr-2 text-[#e5a663]" icon={faMoneyBillTrendUp} />
                        Year bonus
                    </p>
                    <p>
                        <FontAwesomeIcon className="mr-2 text-[#e5a663]" icon={faPersonBreastfeeding} />
