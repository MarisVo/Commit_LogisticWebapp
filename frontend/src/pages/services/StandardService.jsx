  ...
  return (
    <section id="layout-content">
      <div className="h-full lg:h-[610px] w-full relative">
        <img className="lg:absolute lg:right-[0] lg:top-0 w-full h-full lg:w-auto object-cover right-negative-margin" src="https://jtexpress.vn/themes/jtexpress/assets/images/dich-vu-detail.jpg" alt="https://jtexpress.vn/themes/jtexpress/assets/images/dich-vu-detail.png" />
          ...
          <div className="w-full h-auto lg:w-[540px] relative">
            ...
            <div className="lg:absolute left-[40%] lg:top-[50%] lg:translate-x-[-50%] lg:translate-y-[-50%] lg:w-full lg:h-full lg:py-6 px-4 lg:px-0">
              <h5 className="mt-6 lg:mt-0 text-[#f5c736] font-bold text-[24px] lg:text-[32px] aos-init" data-aos="fade-right">
                Dịch vụ chuyển phát tiêu chuẩn</h5>
        ...
        <div className="wrapper_description_service px-4 grid lg:px-0 md:grid-cols-1 sm:grid-cols-1  lg:grid-cols-[700px_minmax(400px,_1fr)_200px] gap-[100px]  ">
          <div className="wrapper_description_service_detail mt-16 lg:mt-0 grid lg:grid-cols-2 gap-[30px] md:grid-cols-1 sm:grid-cols-1">
            <div className="flex item-start">
              <img className="w-[48px] h-[48px] object-cover" src="https://jtexpress.vn/themes/jtexpress/assets/images/money-bag-service-detail.png" alt />
              <div className="flex flex-col ml-4">
                <h5 className="mb-2 text-[#f5c736] text-[20px] font-bold">
                  Tiết kiệm hơn
                </h5>
                <span className="text-justify aos-init">
                  Giá thành của J&amp;T Express được điều chỉnh hợp lý và tiết kiệm nhất cho khách hàng. Các chủ shop, cá nhân buôn bán, mua sắm online có cơ hội tối đa hóa lợi nhuận trong hoạt động kinh doanh của mình.
                </span>
              </div>
            </div>
            <div className="flex item-start">
              <img className="w-[48px] h-[48px] object-cover" src="https://jtexpress.vn/themes/jtexpress/assets/images/time-service-detail.png" alt />
              <div className="flex flex-col ml-4">
                <h5 className="mb-2 text-[#f5c736] text-[20px]  font-bold">
                  Tiện lợi hơn
                </h5>
                <span className="text-justify aos-init" >
                  J&amp;T Express có thể vận chuyển được đa dạng, hầu hết loại hàng hóa. Đặc biệt, có thể vận chuyển hàng với kích thước lớn, trọng lượng có thể lên đến 70kg, giảm nhẹ gánh nặng hàng to.
                </span>
              </div>
            </div>
            <div className="flex item-start">
              <img className="w-[48px] h-[48px] object-cover" src="https://jtexpress.vn/themes/jtexpress/assets/images/delivery-time-service-detail.png" alt />
              <div className="flex flex-col ml-4">
                <h5 className="mb-2 text-[#f5c736] text-[20px]  font-bold">
                  Vượt trội hơn
                </h5>
                <span className="text-justify aos-init" >
                  Khi đăng ký sử dụng dịch vụ chuyển phát tiêu chuẩn J&amp;T Express, hàng hóa được đội ngũ "áo đỏ" đến tận nơi lấy đi. Quá trình tiếp nhận và vận chuyển sử dụng nhiều loại hình vận tải, đáp ứng tối đa nhu cầu của khách hàng.
                </span>
              </div>
            </div>
            <div>
              <img className="w-auto h-auto object-cover hidden lg:block" src="https://jtexpress.vn/themes/jtexpress/assets/images/service_detail_logo.png" alt />
            </div>
          </div>
      ...
      <div className="lg:bg-[#F4F4F4] lg:pt-[63px] lg:pb-[58px]">
        <div className="container mx-auto mt-10 lg:mt-0 px-4 lg:px-0 mb-10 lg:mb-0 ">
          ...
          <span className="block text-center mt-5 mb-4 w-full lg:w-[578px] mx-auto aos-init" data-aos="zoom-in">
            Dịch vụ chuyển phát tiêu chuẩn - J&amp;T Express dành cho tất cả mọi người có nhu cầu vận chuyển hàng hóa
          </span>
          ...
          <div className="wrapper_objects_service grid  grid-cols-2 gap-[20px]  " >
            <div className="h-[315px] lg:h-[244px]  relative rounded-[10px] overflow-hidden">
              <img src="https://jtexpress.vn/themes/jtexpress/assets/images/woman.png" className="w-full h-full object-cover" alt />
              <div className="object-service-detail absolute top-[60%] translate-y-[-60%] left-[10%] text-white w-[170px] lg:w-[320px]">
                ...
                <span data-aos="fade-up" data-aos-duration={1000} className="aos-init">
                  Bất kỳ ai có nhu cầu vận chuyển hàng hóa, gửi hàng đến người thân, bạn bè, đồng nghiệp,... của mình đều có thể lựa chọn Dịch vụ chuyển phát tiêu chuẩn - J&amp;T Express
                </span>
              </div>
            </div>
            <div className="h-[315px] lg:h-[244px] relative rounded-[10px] overflow-hidden">
              <img src="https://jtexpress.vn/themes/jtexpress/assets/images/man1.png" className="w-full h-full object-cover" alt />
              <div className="object-service-detail absolute top-[60%] translate-y-[-60%] left-[10%] text-white w-[170px] lg:w-[320px]">
                <span className="block font-bold mb-3 text-[20px]">
                  Chủ shop
                </span>
                <span data-aos="fade-up" data-aos-duration={1000} className="aos-init">
                  Nếu bạn là chủ shop online, đang tham gia bán hàng tại các nền tảng thương mại điện tử và mạng xã hội thì Dịch vụ chuyển phát tiêu chuẩn - J&amp;T Express này lại càng không thể bỏ qua
                </span>
              </div>
            </div>
          </div>
