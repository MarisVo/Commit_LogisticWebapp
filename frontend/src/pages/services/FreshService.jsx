    ...
    <section id="layout-content">
      ...
      <div className="lg:bg-[#F4F4F4] lg:pt-[63px] lg:pb-[58px]">
        <div className="container mx-auto mt-10 lg:mt-0 px-4 lg:px-0 mb-10 lg:mb-0 ">
          ...
          <div className="wrapper_objects_service grid grid-rows-2 ">
            <div className=" grid grid-cols-2 gap-[20px]">
              <div class="h-[315px] lg:h-[244px]  relative rounded-[10px] overflow-hidden col-span-2 md:col-span-1">
                <img
                ...
                <div class="object-service-detail absolute top-[60%] translate-y-[-60%] left-[10%] text-white w-[170px] lg:w-[320px]">
                  ...
                  <span
                    ...
                    class="aos-init"
                  >
                    Các doanh nghiệp, hợp tác xã,... đang kinh doanh và có nhu
                    cầu vận chuyển hàng tươi sống (thịt, hải sản, nông sản, rau
                    củ quả,...) đến tay người tiêu dùng, doanh nghiệp khác.
                  </span>
                </div>
              </div>
              <div class="h-[315px] lg:h-[244px] relative rounded-[10px] overflow-hidden col-span-2 md:col-span-1">
                ...
                <div class="object-service-detail absolute top-[60%] translate-y-[-60%] left-[10%] text-white w-[170px] lg:w-[320px]">
                  ...
                  <span
                    ...
                    class="aos-init"
                  >
                    Các chủ shop tham gia sàn thương mại điện tử, bán hàng
                    online là các mặt hàng tươi sống, nông sản mong muốn vận
                    chuyển tới tay khách hàng nhanh nhất và tốt nhất.
                  </span>
                </div>
              </div>
            </div>
              ...
              <div class="h-[315px] lg:h-[244px] relative rounded-[10px] overflow-hidden col-span-2 md:col-span-1">
                ...
                <div class="object-service-detail absolute top-[60%] translate-y-[-60%] left-[10%] text-white w-[170px] lg:w-[320px]">
                  ...
                  >
                    ...
                    sống, cần tìm đơn vị chuyển phát nhanh để được hỗ trợ đóng
                    gói và vận chuyển đi xa, tăng nguồn thu nhập.
                  </span>
                </div>
              </div>
              <div class="h-[315px] lg:h-[244px] relative rounded-[10px] overflow-hidden col-span-2 md:col-span-1">
                ...
                <div class="object-service-detail absolute top-[60%] translate-y-[-60%] left-[10%] text-white w-[170px] lg:w-[320px]">
                  ...
                  <span
                    ...
                    class="aos-init"
                  >
                    Cá nhân có nhu cầu vận chuyển các mặt hàng tươi sống đến
                    người thân, bạn bè,... đến khắp 63 tỉnh thành của cả nước
                    đều có thể liên hệ vận chuyển hàng tươi sống.
                  </span>
                </div>
              </div>
            </div>
