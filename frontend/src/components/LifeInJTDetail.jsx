...
import Lijt1 from "../assets/images/lijt1.png";
import {
  faCity,
  faAward,
  faFutbolBall,
      ...
      <div className="lg:gap-x-16 lg:grid lg:grid-cols-2 my-[60px]">
        <div className="tracking-wide">
          ...
          <h5 className="text-base text-[#e5a663] font-bold">
            Tại J&T Express, mỗi cá nhân là một “mảnh ghép" quan trọng tạo nên
            bức tranh đa sắc màu.
          </h5>
          <p className="mb-8">
            Chúng ta tự hào được tập hợp lại thành một đội ngũ thạo kỹ năng,
            chuẩn thái độ, cùng với phong cách sống hiện đại và hết mình. Với
            tinh thần đoàn kết và sẵn sàng giúp đỡ lẫn nhau, chúng ta đang gây
            dựng một nếp văn hóa làm việc tích cực, sẵn sàng vươn xa, dẫn đầu và
            lan tỏa đến nhiều thế hệ tương lai.
          </p>
          ...
          <h4 className="flex gap-2 mb-4 text-xl font-bold">
            <FontAwesomeIcon icon={faCity} className="text-[#e5a663]" /> Trụ sở
            chính
          </h4>
          <p>
            Sofic Tower , 10 Mai Chí Thọ, P. Thủ Thiêm, Thành phố Thủ Đức, TP.
            HCM
          </p>
        </div>
