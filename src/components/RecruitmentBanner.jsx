      ...
      <div className="text-[#fff] tracking-wide text-center absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] w-[80%]">
        <span className="flex">
          ...
          <h2 className="text-[14px] lg:text-3xl text-[#fff]">
            "Tại J&T Express, tôi luôn được trao quyền bày tỏ quan điểm cá nhân
            và sáng tạo. Công ty cũng cố gắng tạo điều kiện để nhân viên cân
        ...
        <p className="text-[14px] lg:text-2xl pt-[20px]">
